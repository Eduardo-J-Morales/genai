...
import { generateRecipe } from '@/app/services/openai';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
      <div className="max-w-4xl mx-auto p-6">
        <header className="text-center mb-12">
          ...
          <p className="text-gray-600">Tell us what ingredients you have, and we'll suggest the perfect recipe!</p>
        </header>
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-8">
          ...
          <button
            ...
            className="w-full px-4 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors disabled:bg-indigo-300 flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
